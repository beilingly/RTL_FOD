...
% 'offset0'表示初始位置，后续端口若为0表示延续上一个端口的位置
% 'width'/0.3, 'depth'/0, 'side' /1 for input, 3 for output
...
% dir define
fdir = 'D:\Project\FOD2\RTL\v1p0\synthesis\synth';
fname = 'FOD_CTRL';
...
for i = 1:length(input_list)
    fcell = [fcell; [input_list(i), {'1'}, {num2str(input_width(1,i))} {num2str(input_width(2,i))} {'6'} {'1'} {'3'} {'0.3'} {'0'} {'1'}]];
end

for i = 1:length(output_list)
    fcell = [fcell; [output_list(i), {'1'}, {num2str(output_width(1,i))} {num2str(output_width(2,i))} {'6'} {'1'} {'3'} {'0.3'} {'0'} {'3'}]];
end
